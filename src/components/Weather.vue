<template>
  <div class="cityWeatherContainer">
    ...
    <div class="inputWrapper">
      <input type="text" placeholder="도시 이름" @keypress="postCityName" v-model="city_name">
      <button class="btn btn-info" @click="getCityWeather">날씨 확인하기</button>
    </div>
...
.cityWeatherContainer .contentWrapper ul li .textContainer .tempWrapper p:first-child {
  font-size: 20px;
}
</style>